...
if(isset($_POST['username']) &&
   ...
   if (empty($name)) {
   	  ...
   	  header("Location: ../../signupadvisor.php?error=$em");
   	  exit;
      ...
      */
   	  header("Location: ../../signupadvisor.php?error=$em&$data");
   	  exit;
      ...
      */
      ...
      if($stmt->rowCount() > 0){
      	...
      	header("Location: ../../indexadvisor.php?success=$sm");
     	exit;
      }

   }
}else {
	header("Location: ../../signupadvisor.php");
   	exit;
}